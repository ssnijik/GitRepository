 ...
 *
 */
public abstract class BaseDao<M extends Serializable, PK extends Serializable> implements IBaseDao<M, PK> {
    ...
    public List<M> pre(PK pk, int pn, int pageSize) {
        ...
        //鍊掑簭锛岄噸鎺�
        List<M> result = this.list(HQL_OPTIMIZE_PRE_LIST_ALL, 1, pageSize, new Object[]{pk});
